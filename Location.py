...
class Location :
    ...
    def __init__(self, levelName, floor, roof, lighting, lightType) :
        ...
        self.dictKey = ''
        ## Tells us whether the location is inside or outside
        self.inOrOut = 'outside'
        ...
        if(self.visited == False and self.gainedAccess != True) :
            ...
            if(prevLocation == 'outside') :
                ...
                if roll <= 8 :
                    ...
                    entered = True
                    nextLocation = 'garage'
            ## Add code for when accessing location from inside
            else :
                print('FROM INDOOR')
            ...
            if(prevLocation == 'outside') :
                ...
                if allowedAccess :
                    ...
                    if superHero == 'BATMAN' :
                        ...
                        entered = self.randomGateOptions()
            ## Add code here for when accessing location from an inside location
            else :
                print('FROM INDOOR')
...
class Lobby(Location) :
    ...
    def locationIntroduction(self, character, deviation = '', prevLocation = 'outside') :
        ...
        if(self.visited == False and self.gainedAccess != True) :
            ...
            ## Add code here for when accessing a location from an outside location
            else :
                print('FROM INDOOR')
...
class DinningRoom(Location) :
    ...
    def locationIntroduction(self, character, deviation = '', prevLocation = 'outside') :
        ...
        if(self.visited == False and self.gainedAccess != True) :
            ...
            if(prevLocation == 'outside') :
                ...
                if (progression == 0) :
                    ...
                    if (character.heightInFeet < 4.5 and character.fitnessLevel == 'Poor') :
                        ...
                        entered = True
                        nextLocation = 'diningRoom'
            ## Code for when accessing this location from an indoor location
            else :
            ...
            if(entered == True) :
                self.gainedAccess = True
        ## Code for when you are inside the location for the first time
        elif (self.visited == False and self.gainedAccess == True) :
            clearConsole(0)
    ...
    def locationIntroduction(self, character, deviation = '', prevLocation = 'outside') :
        ...
        if(self.visited == False and self.gainedAccess != True) :
            ...
            if(prevLocation == 'outside') :
                ...
                entered = True
                nextLocation = 'basement'
            ## Code for entering the location from an indoor location
            else :
                print('FROM INDOOR')
    ...
    def locationIntroduction(self, character, deviation = '', prevLocation = 'outside') :
        ...
        if(self.visited == False and self.gainedAccess != True) :
            ...
            if(prevLocation == 'outside') :
                ...
                print('You step inside...')
                enterCon()
            ## Code for when accessing a location from an indoor location
            else :
                print('FROM INDOOR')
    ...
    def locationIntroduction(self, character, deviation = '', prevLocation = 'outside') :
        ...
        if(self.visited == False and self.gainedAccess != True) :
            ...
            if(prevLocation == 'outside') :
                ...
                enterCon()
            ##Code for when you access the location from an indoor location
            else :
                print('FROM INDOOR')
...
def createLocations() :
    ...
    garage.setConnectedLocations([lobby])
